...
# MAGIC 10. **Semantic layer** (optional) — curated `vw_` views and governed `mv_` metric views
...
DEFAULT_ENABLE_SEMANTIC_LAYER = "true"  # "false" skips the vw_ and mv_ semantic objects
# =============================================================================
...
ENABLE_SEMANTIC_LAYER = (
    widget_value(
        "enable_semantic_layer",
        DEFAULT_ENABLE_SEMANTIC_LAYER,
        "Generate the curated views and metric views",
        ["true", "false"],
    ).lower()
    == "true"
)
...
print(
    ...
    f"as_of_date={AS_OF_DATE} enable_semantic_layer={ENABLE_SEMANTIC_LAYER}"
)
# COMMAND ----------
...
# MAGIC each planned Genie domain. Set `enable_semantic_layer` to `false` to skip
# MAGIC this phase, for example on runtimes without metric-view support.
# COMMAND ----------
...
if ENABLE_SEMANTIC_LAYER:
    ...
    print("enable_semantic_layer is false — skipping curated views.")
# COMMAND ----------
...
if ENABLE_SEMANTIC_LAYER:
    ...
    print("enable_semantic_layer is false — skipping metric views.")
    results["semantic_layer"] = {"skipped": True, "reason": "enable_semantic_layer is false"}
# COMMAND ----------
