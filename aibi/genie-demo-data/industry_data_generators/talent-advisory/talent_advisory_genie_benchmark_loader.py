...
BENCHMARKS = [
    # ---------------- EASY (5) ----------------
    {
        "question": "How many active employees do we currently have?",
        "difficulty": "EASY",
        "sql": "SELECT COUNT(*) AS active_employees FROM `{catalog}`.`{schema}`.`employees` WHERE is_active = true",
    },
    {
        "question": "How many work locations do we have in each region?",
        "difficulty": "EASY",
    ...
    {
        "question": "How many roles are flagged as critical roles?",
        "difficulty": "EASY",
        "sql": "SELECT COUNT(*) AS critical_roles FROM `{catalog}`.`{schema}`.`job_roles` WHERE is_critical_role = true",
    },
    {
        "question": "How many employees have left, broken down by termination type?",
        "difficulty": "EASY",
    ...
    {
        "question": "How many learning activities are completed versus in progress or dropped?",
        "difficulty": "EASY",
    ...
    # ---------------- MEDIUM (15) ----------------
    {
        "question": "For filled requisitions, what is the average time to fill and the total offers and accepted offers by job family?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "Which org units have the most open requisitions right now? Show the top 10 by org unit name.",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "What is the offer acceptance rate by candidate market segment (scarce, competitive, balanced)?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "What is the average base salary and compa-ratio by job level for 2025?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "In the most recent quarter, how many high-risk employees and what average engagement score does each business unit have?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "How has the average engagement score trended by quarter?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "How many promotions, transfers, internal fills, and learning completions happened each year across the company?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "Which skills have the largest average skill gap? Show the top 10 by skill name.",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "What share of filled requisitions were filled internally each year?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "In 2025, how many hires and exits did each business unit have, and what was the annual attrition rate?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "Who are the 10 employees with the highest total cash compensation (base plus bonus) in 2025? Show their names and roles.",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "What is the distribution of employees across performance buckets in the 2025 review cycle?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "Which job families have the most critical skill gaps among employees?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "What is the readiness-level breakdown of named successors in our succession plans?",
        "difficulty": "MEDIUM",
    ...
    {
        "question": "How many active employees and what is the average compa-ratio in each region?",
        "difficulty": "MEDIUM",
    ...
    # ---------------- HARD (10) ----------------
    {
        "question": "For each business unit, which job family carries the highest average retention risk in 2025?",
        "difficulty": "HARD",
    ...
    {
        "question": "How did the average engagement score for Sales East change year over year from 2023 to 2025?",
        "difficulty": "HARD",
    ...
    {
        "question": "Compare the average peak annual retention risk of high performers paid below 0.90 compa-ratio against other high performers and everyone else.",
        "difficulty": "HARD",
    ...
    {
        "question": "What is the median and 90th-percentile time to fill for filled requisitions by job family?",
        "difficulty": "HARD",
    ...
    {
        "question": "For employees hired in 2023, what percentage were still active at the end of 2024 and at the end of 2025?",
        "difficulty": "HARD",
    ...
    {
        "question": "Rank job families by 2025 regretted-loss exits and show each family's share of all regretted losses.",
        "difficulty": "HARD",
    ...
    {
        "question": "By job family in 2025, what is the gap between the average compa-ratio of high performers and everyone else?",
        "difficulty": "HARD",
    ...
    {
        "question": "Which org units had the biggest increase in high-risk employees from Q1 2024 to Q4 2024? Show the top 10.",
        "difficulty": "HARD",
    ...
    {
        "question": "What are the median and 90th-percentile accepted offer salaries by business unit for offers accepted in 2025?",
        "difficulty": "HARD",
    ...
    {
        "question": "For requisitions filled in 2025, what is each business unit's internal-fill rate, and how does it compare to the company-wide internal-fill rate?",
        "difficulty": "HARD",
...
print(
    f"instructions keys  : {list((pre_instructions or {}).keys()) if isinstance(pre_instructions, dict) else type(pre_instructions).__name__}"
)
...
), "benchmark question text does not match what was sent"
...
assert (
    post_data_sources == pre_data_sources
), "data_sources changed - it must remain untouched"
assert (
    post_instructions == pre_instructions
), "instructions changed - they must remain untouched"
