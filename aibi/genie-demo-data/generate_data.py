...
STATE_REGION = {
    ...
    "CT": "Northeast", "PA": "Northeast",
    "FL": "Southeast", "GA": "Southeast", "NC": "Southeast",
    "SC": "Southeast", "VA": "Southeast", "TN": "Southeast",
    "IL": "Midwest",   "OH": "Midwest",   "MI": "Midwest",
    "IN": "Midwest",   "WI": "Midwest",   "MN": "Midwest",
    "CA": "West",      "WA": "West",      "OR": "West",
    "TX": "Southwest", "AZ": "Southwest", "NV": "Southwest",
    "NM": "Southwest", "CO": "Southwest",
}

# State pool for customer assignment (weighted toward NY, CA, TX, FL, IL)
CUSTOMER_STATES  = ["NY","CA","TX","FL","IL","NJ","MA","GA","NC","WA",
                    "OH","MI","PA","VA","AZ","CO","SC","IN","WI","OR"]
STATE_WEIGHTS    = [13,  12,  10,  10,  7,   6,   5,   4,   4,   4,
                    4,   3,   3,   3,   3,   2,   2,   2,   2,   1]
...
products_data = [
    # ── DEPOSIT ──────────────────────────────────────────────────────────────
    {"product_id": "PROD-001", "product_name": "Horizon Basic Checking",
     "product_category": "Deposit",  "product_type": "Checking",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 0.00,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-002", "product_name": "Horizon Plus Checking",
     "product_category": "Deposit",  "product_type": "Checking",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 0.01,
     "reward_program": "Cash Back",  "min_balance_usd": 1500.0,
     "is_active": True,  "launched_date": date(2012, 6, 1)},

    {"product_id": "PROD-003", "product_name": "Horizon Premier Checking",
     "product_category": "Deposit",  "product_type": "Checking",
     "annual_fee_usd": 25.0, "base_interest_rate_pct": 0.05,
     "reward_program": "Points",     "min_balance_usd": 5000.0,
     "is_active": True,  "launched_date": date(2015, 3, 1)},

    {"product_id": "PROD-004", "product_name": "Horizon Business Checking",
     "product_category": "Deposit",  "product_type": "Checking",
     "annual_fee_usd": 15.0, "base_interest_rate_pct": 0.00,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2013, 1, 1)},

    {"product_id": "PROD-005", "product_name": "Horizon Basic Savings",
     "product_category": "Deposit",  "product_type": "Savings",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 0.50,
     "reward_program": "None",       "min_balance_usd": 100.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-006", "product_name": "Horizon High-Yield Savings",
     "product_category": "Deposit",  "product_type": "Savings",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 4.50,
     "reward_program": "None",       "min_balance_usd": 1000.0,
     "is_active": True,  "launched_date": date(2019, 7, 15)},

    {"product_id": "PROD-007", "product_name": "Horizon Money Market",
     "product_category": "Deposit",  "product_type": "Savings",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 3.80,
     "reward_program": "None",       "min_balance_usd": 2500.0,
     "is_active": True,  "launched_date": date(2015, 1, 1)},

    {"product_id": "PROD-008", "product_name": "Horizon 12-Month CD",
     "product_category": "Deposit",  "product_type": "Savings",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 5.10,
     "reward_program": "None",       "min_balance_usd": 500.0,
     "is_active": True,  "launched_date": date(2020, 1, 1)},

    {"product_id": "PROD-009", "product_name": "Horizon Student Savings",
     "product_category": "Deposit",  "product_type": "Savings",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 1.00,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2018, 9, 1)},

    # ── CREDIT ───────────────────────────────────────────────────────────────
    {"product_id": "PROD-010", "product_name": "Horizon Rewards Visa",
     "product_category": "Credit",   "product_type": "Credit Card",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 19.99,
     "reward_program": "Cash Back",  "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2011, 4, 1)},

    {"product_id": "PROD-011", "product_name": "Horizon Platinum Card",
     "product_category": "Credit",   "product_type": "Credit Card",
     "annual_fee_usd": 95.0, "base_interest_rate_pct": 17.99,
     "reward_program": "Points",     "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2013, 1, 1)},

    {"product_id": "PROD-012", "product_name": "Horizon Travel Rewards Card",
     "product_category": "Credit",   "product_type": "Credit Card",
     "annual_fee_usd": 195.0,"base_interest_rate_pct": 20.99,
     "reward_program": "Miles",      "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2016, 6, 15)},

    {"product_id": "PROD-013", "product_name": "Horizon Business Credit Card",
     "product_category": "Credit",   "product_type": "Credit Card",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 21.99,
     "reward_program": "Cash Back",  "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2014, 3, 1)},

    # ── LENDING ──────────────────────────────────────────────────────────────
    {"product_id": "PROD-014", "product_name": "Horizon 30yr Fixed Mortgage",
     "product_category": "Lending",  "product_type": "Mortgage",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 6.75,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-015", "product_name": "Horizon 15yr Fixed Mortgage",
     "product_category": "Lending",  "product_type": "Mortgage",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 6.00,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-016", "product_name": "Horizon 5/1 ARM Mortgage",
     "product_category": "Lending",  "product_type": "Mortgage",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 5.50,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2012, 1, 1)},

    {"product_id": "PROD-017", "product_name": "Horizon Auto Loan 48-Month",
     "product_category": "Lending",  "product_type": "Auto Loan",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 5.25,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-018", "product_name": "Horizon Auto Loan 60-Month",
     "product_category": "Lending",  "product_type": "Auto Loan",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 5.75,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2010, 1, 1)},

    {"product_id": "PROD-019", "product_name": "Horizon Home Equity Line",
     "product_category": "Lending",  "product_type": "HELOC",
     "annual_fee_usd": 50.0, "base_interest_rate_pct": 7.50,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2011, 1, 1)},

    {"product_id": "PROD-020", "product_name": "Horizon Home Equity Loan",
     "product_category": "Lending",  "product_type": "HELOC",
     "annual_fee_usd": 0.0,  "base_interest_rate_pct": 7.00,
     "reward_program": "None",       "min_balance_usd": 0.0,
     "is_active": True,  "launched_date": date(2011, 6, 1)},
]
...
def _branch(bid, name, btype, region, state, city, opened, cost, hc):
    return {
        "branch_id": bid, "branch_name": name, "branch_type": btype,
        "region": region, "state": state, "city": city,
        "opened_date": date(*opened),
        "monthly_operating_cost_usd": float(cost),
        "headcount": hc, "is_active": True,
    }

branches_data = [
    # ── NORTHEAST (6) ────────────────────────────────────────────────────────
    _branch("BRNCH-001","Manhattan Financial District Branch","Full Service",   "Northeast","NY","New York",    (2005,3,1),  145000,32),
    _branch("BRNCH-002","Brooklyn Heights Branch",           "Full Service",   "Northeast","NY","Brooklyn",     (2008,7,1),  118000,25),
    _branch("BRNCH-003","Long Island Branch",                "Limited Service","Northeast","NY","Garden City",  (2011,4,1),  72000, 13),
    _branch("BRNCH-004","Newark Main Branch",                "Full Service",   "Northeast","NJ","Newark",       (2006,9,1),  105000,22),
    _branch("BRNCH-005","Princeton Branch",                  "Limited Service","Northeast","NJ","Princeton",    (2014,2,1),  65000, 11),
    _branch("BRNCH-006","Boston Financial Branch",           "Full Service",   "Northeast","MA","Boston",       (2007,5,1),  132000,28),

    # ── SOUTHEAST (6) — injected: 20% higher avg txn value ──────────────────
    _branch("BRNCH-007","Miami South Branch",                "Full Service",   "Southeast","FL","Miami",        (2006,1,1),  138000,30),
    _branch("BRNCH-008","Orlando Central Branch",            "Full Service",   "Southeast","FL","Orlando",      (2009,3,1),  112000,24),
    _branch("BRNCH-009","Tampa Bay Branch",                  "Limited Service","Southeast","FL","Tampa",        (2013,6,1),  68000, 12),
    _branch("BRNCH-010","Atlanta Midtown Branch",            "Full Service",   "Southeast","GA","Atlanta",      (2007,11,1), 125000,27),
    _branch("BRNCH-011","Savannah Branch",                   "Drive-Through",  "Southeast","GA","Savannah",     (2015,4,1),  32000,  6),
    _branch("BRNCH-012","Charlotte Branch",                  "Full Service",   "Southeast","NC","Charlotte",    (2010,8,1),  108000,23),

    # ── MIDWEST (5) ──────────────────────────────────────────────────────────
    _branch("BRNCH-013","Chicago Loop Branch",               "Full Service",   "Midwest",  "IL","Chicago",      (2004,6,1),  150000,35),
    _branch("BRNCH-014","Chicago North Shore Branch",        "Limited Service","Midwest",  "IL","Evanston",     (2010,1,1),  74000, 14),
    _branch("BRNCH-015","Chicago South Branch",              "Drive-Through",  "Midwest",  "IL","Oak Park",     (2012,9,1),  38000,  7),
    _branch("BRNCH-016","Columbus Branch",                   "Full Service",   "Midwest",  "OH","Columbus",     (2009,4,1),  98000, 20),
    _branch("BRNCH-017","Detroit Branch",                    "Full Service",   "Midwest",  "MI","Detroit",      (2011,2,1),  95000, 19),

    # ── WEST (4) ─────────────────────────────────────────────────────────────
    _branch("BRNCH-018","Los Angeles Downtown Branch",       "Full Service",   "West",     "CA","Los Angeles",  (2005,9,1),  148000,33),
    _branch("BRNCH-019","San Francisco Financial Branch",    "Full Service",   "West",     "CA","San Francisco",(2006,3,1),  152000,34),
    _branch("BRNCH-020","San Diego Branch",                  "Limited Service","West",     "CA","San Diego",    (2012,5,1),  79000, 15),
    _branch("BRNCH-021","Seattle Branch",                    "Full Service",   "West",     "WA","Seattle",      (2010,7,1),  115000,24),

    # ── SOUTHWEST (4) ────────────────────────────────────────────────────────
    _branch("BRNCH-022","Houston Main Branch",               "Full Service",   "Southwest","TX","Houston",      (2006,2,1),  128000,27),
    _branch("BRNCH-023","Dallas Branch",                     "Full Service",   "Southwest","TX","Dallas",       (2008,10,1), 122000,26),
    _branch("BRNCH-024","Austin Branch",                     "Limited Service","Southwest","TX","Austin",       (2014,6,1),  71000, 13),
    _branch("BRNCH-025","Phoenix Branch",                    "Full Service",   "Southwest","AZ","Phoenix",      (2009,1,1),  103000,21),
]
...
HAS_FLAGS = {
    "Standard":       {"checking": 0.70, "savings": 0.62, "credit_card": 0.38, "mortgage": 0.18},
    "Preferred":      {"checking": 0.88, "savings": 0.78, "credit_card": 0.62, "mortgage": 0.34},
    "Private Client": {"checking": 0.97, "savings": 0.90, "credit_card": 0.80, "mortgage": 0.60},
}
...
for i in range(1, 1001):
    cid   = f"CUST-{i:04d}"
    tier  = random.choices(
        ["Standard", "Preferred", "Private Client"],
        weights=[60, 30, 10]
    )[0]
    ...
    if tier == "Private Client":
        segment = random.choices(
            ["Retail", "Small Business", "Wealth Management"],
            weights=[15, 30, 55]
        )[0]
    elif tier == "Preferred":
        segment = random.choices(
...
for cust in customers_data:
    ...
    for idx, atype in enumerate(account_types):
        ...
        status = random.choices(
            ["Active", "Dormant", "Closed", "Delinquent"],
            weights=[78, 10, 8, 4]
        )[0]
...
hv_accounts  = [a["account_id"] for a in accounts_data
                if account_cust_map[a["account_id"]] in HIGH_VALUE_CUSTOMERS]
reg_accounts = [a["account_id"] for a in accounts_data
                if account_cust_map[a["account_id"]] not in HIGH_VALUE_CUSTOMERS]

# ── Transaction type weights by account type ──────────────────────────────────
TXN_TYPES = {
    "Checking":    (["Deposit","Withdrawal","Transfer","Payment","Fee","Interest"],
                   [ 25,       25,          20,        15,       8,    7]),
    "Savings":     (["Deposit","Withdrawal","Transfer","Interest","Fee"],
                   [ 35,       15,          20,        25,        5]),
    "Credit Card": (["Purchase","Payment","Fee","Interest"],
                   [ 55,        30,       10,    5]),
    "Mortgage":    (["Payment","Fee","Interest"],
                   [ 80,        10,   10]),
    "Auto Loan":   (["Payment","Fee","Interest"],
                   [ 80,        10,   10]),
    "Home Equity": (["Payment","Withdrawal","Fee","Interest"],
                   [ 65,        20,          10,    5]),
}

MERCHANT_CATS = ["Groceries","Travel","Dining","Gas","Retail","Healthcare","Entertainment"]
...
for a in accounts_data:
    account_running_balance[a["account_id"]] = a["current_balance_usd"] * random.uniform(0.8, 1.2)
...
for month_idx, (year, month) in enumerate(MONTH_LIST):
    ...
    for _ in range(n_txns):
        ...
        # Status & flag
        status    = random.choices(["Posted","Pending","Reversed"],
                                   weights=[95, 3, 2])[0]
...
sr_month_weights = [1.80 if (y == 2024 and m == 1) else 1.0
                    for (y, m) in MONTH_LIST]
...
SR_CATEGORIES = ["Account Inquiry", "Dispute", "Complaint",
...
for month_idx, (year, month) in enumerate(MONTH_LIST):
    ...
    for _ in range(n_srs):
        ...
        if status == "Resolved":
            if category == "Complaint":
                sat_score = random.choices([1, 2, 3, 4, 5], weights=[20, 30, 25, 15, 10])[0]
            else:
                sat_score = random.choices([1, 2, 3, 4, 5], weights=[5,  10, 20, 35, 30])[0]
...
print("ROW COUNTS")
print("=" * 60)
for tbl in ["products","branches","customers","accounts","transactions","service_requests"]:
...
# --- Primary keys ---
spark.sql(f"ALTER TABLE {C}.products         ADD CONSTRAINT pk_products         PRIMARY KEY (product_id)")
spark.sql(f"ALTER TABLE {C}.branches         ADD CONSTRAINT pk_branches         PRIMARY KEY (branch_id)")
spark.sql(f"ALTER TABLE {C}.customers        ADD CONSTRAINT pk_customers        PRIMARY KEY (customer_id)")
spark.sql(f"ALTER TABLE {C}.accounts         ADD CONSTRAINT pk_accounts         PRIMARY KEY (account_id)")
spark.sql(f"ALTER TABLE {C}.transactions     ADD CONSTRAINT pk_transactions     PRIMARY KEY (transaction_id)")
spark.sql(f"ALTER TABLE {C}.service_requests ADD CONSTRAINT pk_service_requests PRIMARY KEY (request_id)")

# --- Foreign keys ---
spark.sql(f"ALTER TABLE {C}.customers        ADD CONSTRAINT fk_customers_branch    FOREIGN KEY (primary_branch_id) REFERENCES {C}.branches (branch_id)")
spark.sql(f"ALTER TABLE {C}.accounts         ADD CONSTRAINT fk_accounts_customer   FOREIGN KEY (customer_id)       REFERENCES {C}.customers (customer_id)")
spark.sql(f"ALTER TABLE {C}.accounts         ADD CONSTRAINT fk_accounts_product    FOREIGN KEY (product_id)        REFERENCES {C}.products (product_id)")
spark.sql(f"ALTER TABLE {C}.transactions     ADD CONSTRAINT fk_transactions_account  FOREIGN KEY (account_id)      REFERENCES {C}.accounts (account_id)")
spark.sql(f"ALTER TABLE {C}.transactions     ADD CONSTRAINT fk_transactions_customer FOREIGN KEY (customer_id)     REFERENCES {C}.customers (customer_id)")
spark.sql(f"ALTER TABLE {C}.transactions     ADD CONSTRAINT fk_transactions_branch   FOREIGN KEY (branch_id)       REFERENCES {C}.branches (branch_id)")
spark.sql(f"ALTER TABLE {C}.service_requests ADD CONSTRAINT fk_sr_customer          FOREIGN KEY (customer_id)      REFERENCES {C}.customers (customer_id)")
spark.sql(f"ALTER TABLE {C}.service_requests ADD CONSTRAINT fk_sr_branch            FOREIGN KEY (branch_id)        REFERENCES {C}.branches (branch_id)")

# --- Column comments: products ---
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN product_id             COMMENT 'Primary key. Format: PROD-NNN'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN product_name           COMMENT 'Full commercial name of the product (e.g., Horizon Rewards Visa)'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN product_category       COMMENT 'High-level category: Deposit, Credit, or Lending'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN product_type           COMMENT 'Specific type: Checking, Savings, Credit Card, Mortgage, Auto Loan, HELOC'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN annual_fee_usd         COMMENT 'Annual fee charged to the customer in USD. 0 for fee-free products'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN base_interest_rate_pct COMMENT 'Base APR or APY in percent (e.g., 19.99 means 19.99%). Deposit rates are APY; lending rates are APR'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN reward_program         COMMENT 'Loyalty/reward program: None, Cash Back, Points, or Miles'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN min_balance_usd        COMMENT 'Minimum balance required to avoid fees or qualify for rate. 0 if no minimum'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN is_active              COMMENT 'True if the product is currently offered to new customers'")
spark.sql(f"ALTER TABLE {C}.products ALTER COLUMN launched_date          COMMENT 'Date the product was first made available'")

# --- Column comments: branches ---
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN branch_id                   COMMENT 'Primary key. Format: BRNCH-NNN'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN branch_name                 COMMENT 'Descriptive name of the branch location'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN branch_type                 COMMENT 'Service level: Full Service, Limited Service, or Drive-Through'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN region                      COMMENT 'Geographic region: Northeast, Southeast, Midwest, West, Southwest'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN state                       COMMENT 'US 2-letter state code (e.g., NY, CA)'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN city                        COMMENT 'City where the branch is located'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN opened_date                 COMMENT 'Date the branch first opened for business'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN monthly_operating_cost_usd  COMMENT 'Fixed monthly cost to operate the branch in USD (rent, salaries, utilities)'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN headcount                   COMMENT 'Number of full-time employees at the branch'")
spark.sql(f"ALTER TABLE {C}.branches ALTER COLUMN is_active                   COMMENT 'True if the branch is currently open'")

# --- Column comments: customers ---
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN customer_id         COMMENT 'Primary key. Format: CUST-NNNN'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN customer_name       COMMENT 'Full name of the customer'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN age_band            COMMENT 'Age range bracket: 18-24, 25-34, 35-44, 45-54, 55-64, 65+'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN income_band         COMMENT 'Annual household income bracket: <$50K, $50K-$100K, $100K-$200K, $200K+'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN customer_segment    COMMENT 'Business segment: Retail, Small Business, or Wealth Management'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN relationship_tier   COMMENT 'Relationship depth tier: Standard, Preferred, or Private Client. Private Client customers hold 3x higher average balances'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN state               COMMENT 'US 2-letter state code for customer primary residence'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN region              COMMENT 'Geographic region derived from state: Northeast, Southeast, Midwest, West, Southwest'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN primary_branch_id   COMMENT 'FK → branches. The branch this customer is primarily associated with'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN acquisition_channel COMMENT 'How the customer was acquired: Branch, Online, Mobile, or Referral'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN customer_since_date COMMENT 'Date the customer first opened a relationship with Horizon Bank'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN is_active           COMMENT 'True if the customer relationship is active (~94% of customers)'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN has_checking        COMMENT 'True if the customer holds at least one checking account'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN has_savings         COMMENT 'True if the customer holds at least one savings account'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN has_credit_card     COMMENT 'True if the customer holds at least one credit card'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN has_mortgage        COMMENT 'True if the customer holds at least one mortgage. Private Client: ~60% penetration'")
spark.sql(f"ALTER TABLE {C}.customers ALTER COLUMN credit_score_band   COMMENT 'Credit score bracket: Poor (<580), Fair (580-669), Good (670-739), Very Good (740-799), Exceptional (800+)'")

# --- Column comments: accounts ---
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN account_id          COMMENT 'Primary key. Format: ACCT-NNNNN'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN customer_id         COMMENT 'FK → customers. Owner of this account'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN product_id          COMMENT 'FK → products. The specific product this account is based on'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN account_type        COMMENT 'Type of account: Checking, Savings, Credit Card, Mortgage, Auto Loan, Home Equity'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN open_date           COMMENT 'Date the account was opened'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN close_date          COMMENT 'Date the account was closed. NULL if account is still open'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN status              COMMENT 'Current account status: Active, Dormant, Closed, or Delinquent'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN current_balance_usd COMMENT 'Current balance in USD. For credit accounts: outstanding balance owed. For deposit accounts: available balance'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN credit_limit_usd    COMMENT 'Credit limit in USD. Only populated for Credit Card and HELOC accounts; NULL for deposit and other lending accounts'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN interest_rate_pct   COMMENT 'Account-specific interest rate in percent. May vary from product base_interest_rate_pct due to promotional or relationship pricing'")
spark.sql(f"ALTER TABLE {C}.accounts ALTER COLUMN is_primary_account  COMMENT 'True if this is the customer''s primary account (typically the first checking account)'")

# --- Column comments: transactions ---
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_id      COMMENT 'Primary key. Format: TXN-NNNNNNN'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_date    COMMENT 'Date the transaction occurred. Range: 2023-01-01 to 2025-12-31'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_year    COMMENT 'Calendar year of the transaction (2023, 2024, or 2025). Redundant column for easy filtering without date functions'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_month   COMMENT 'Calendar month of the transaction (1–12). Redundant column for easy filtering'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_quarter COMMENT 'Calendar quarter of the transaction (1–4). Redundant column for easy filtering'")
...
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN customer_id         COMMENT 'FK → customers. Denormalized from accounts for query convenience'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN branch_id           COMMENT 'FK → branches. NULL for digital-channel transactions (Online, Mobile, ATM, Wire)'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN transaction_type    COMMENT 'Type: Deposit (in), Withdrawal (out), Transfer, Payment, Purchase (credit card), Fee, or Interest. Amounts are always positive — direction is determined by transaction_type'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN channel             COMMENT 'Channel used: Branch, ATM, Online, Mobile, or Wire. Mobile share grows from 25% (Jan 2023) to 48% (Dec 2025)'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN amount_usd          COMMENT 'Transaction amount in USD. Always stored as a positive value. Use transaction_type to determine direction of money flow'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN fee_usd             COMMENT 'Explicit fee in USD. Separate from amount_usd. 0 for most transactions — non-zero for wire transfers and overdraft events. Grows ~20% YoY'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN balance_after_usd   COMMENT 'Account balance after this transaction was applied'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN merchant_category   COMMENT 'Merchant category for credit card purchases only: Groceries, Travel, Dining, Gas, Retail, Healthcare, Entertainment. NULL for all other transaction types'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN is_international    COMMENT 'True if the transaction involved a foreign counterparty or cross-border transfer'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN status              COMMENT 'Settlement status: Posted (cleared), Pending, or Reversed'")
spark.sql(f"ALTER TABLE {C}.transactions ALTER COLUMN is_flagged          COMMENT 'True if the transaction was flagged by fraud or AML monitoring (~0.5% of transactions)'")

# --- Column comments: service_requests ---
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN request_id            COMMENT 'Primary key. Format: SR-NNNNNN'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN request_date          COMMENT 'Date the service request was submitted. Range: 2023-01-01 to 2025-12-31'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN request_year          COMMENT 'Calendar year of the request. Redundant for easy filtering'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN request_month         COMMENT 'Calendar month of the request (1–12). Redundant for easy filtering'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN customer_id           COMMENT 'FK → customers. The customer who submitted this request'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN branch_id             COMMENT 'FK → branches. NULL for non-branch channels (Phone, Chat, App)'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN channel               COMMENT 'Channel used to submit the request: Phone, Chat, Branch, or App'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN category              COMMENT 'Category: Account Inquiry, Dispute, Complaint, Product Inquiry, or Technical Issue. Complaint requests spike +80% in Jan 2024 (system outage narrative)'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN status                COMMENT 'Resolution status: Resolved, Open, or Escalated'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN resolution_time_days  COMMENT 'Days from submission to resolution. NULL if still Open. Escalated requests may have a partial value'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN satisfaction_score    COMMENT 'Customer satisfaction rating 1–5 (5 = most satisfied). NULL if not yet rated. Lower scores correlate with Complaint category'")
spark.sql(f"ALTER TABLE {C}.service_requests ALTER COLUMN is_resolved           COMMENT 'True if status = Resolved. Convenience boolean for filtering'")

# --- Table comments ---
spark.sql(f"COMMENT ON TABLE {C}.products IS 'Product catalog for Horizon Bank. 20 rows covering Deposit, Credit, and Lending product types. Static reference dimension.'")
spark.sql(f"COMMENT ON TABLE {C}.branches IS 'Branch dimension for Horizon Bank. 25 branches across 5 US regions. Southeast branches have ~20% higher average transaction values vs. national average.'")
spark.sql(f"COMMENT ON TABLE {C}.customers IS 'Customer dimension. 1,000 synthetic customers. Private Client tier (top 10%) holds 3x the average account balance and has 60% mortgage penetration.'")
spark.sql(f"COMMENT ON TABLE {C}.accounts IS 'Account dimension. ~2,500 accounts across all product types. FK to customers and products. current_balance_usd reflects the balance after all transactions in the 2023–2025 window.'")
spark.sql(f"COMMENT ON TABLE {C}.transactions IS 'Primary fact table. 10,000 transactions from 2023-01-01 to 2025-12-31. Key patterns: (1) Nov/Dec volume +45%, (2) Q2 2024 deposit dip -15%, (3) Mobile channel grows 25% to 48%, (4) Fee revenue +20% YoY, (5) Top 10% customers = ~35% of deposit volume. Amounts are always positive — use transaction_type for direction.'")
spark.sql(f"COMMENT ON TABLE {C}.service_requests IS 'Secondary fact table. 3,000 service requests from 2023–2025. Complaint category spikes +80% in Jan 2024, correlating with a simulated system outage narrative.'")
