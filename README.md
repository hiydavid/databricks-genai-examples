...
| Example | What it covers |
| --- | --- |
| [Genie optimization workflow](aibi/genie-optimization-workflow/) | Snapshot a space, validate benchmarks, measure baseline accuracy, optimize with Genie Code tasks, and record an audit trail. **Prototype; requires the Genie Code Job Task preview.** |
